...
bool Renderer::checkDeviceExtensionSupport(VkPhysicalDevice physical_device) {
    // Checking Extension Support
...
Renderer::SwapChainSupportDetails Renderer::querySwapChainSupport(VkPhysicalDevice physical_device){
...
void Renderer::endSingleTimeCommandBuffer(VkCommandBuffer commandBuffer){
...
VkCommandBuffer Renderer::setupCommandBuffer() {
  VkCommandBufferAllocateInfo allocInfo{};
  allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
  allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
  allocInfo.commandPool = commandPool;
...
void Renderer::flushSetupCommandBuffer(VkCommandBuffer commandBuffer) {
  vkEndCommandBuffer(commandBuffer);
